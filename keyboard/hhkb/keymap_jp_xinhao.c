...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
     ...
     * |-----------------------------------------------------------|
     * |       |PrT|Pla|NxT|   |   |  +|  -|End|PgD|Dow|   |PgU|   |
     * |-----------------------------------------------------------|
     * |   ||   |   |   |   |         |   |   |MNU|   ||Hom|PgD|End|
     * `-----------------------------------------------------------'
     */
    [1] =
    KEYMAP_JP(TRNS,F1  ,F2  ,F3  ,F4  ,F5  ,F6  ,F7  ,F8  ,F9  ,F10 ,F11 ,F12 ,INS ,DEL ,\
              ...
              TRNS    ,MPRV,MPLY,MNXT,TRNS,TRNS,PPLS,PMNS,END, PGDN,DOWN,TRNS,PGUP,TRNS, \
              TRNS,TRNS,TRNS,TRNS,TRNS,    TRNS    ,TRNS,RGUI,APP ,TRNS, HOME,PGDN,END),
